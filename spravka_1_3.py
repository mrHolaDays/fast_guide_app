...
class GlossaryApp:
        ...
        try:
            ...
            for i in file_list:
                if len(i) == 3 and i[2].strip():
                    file_frame = ctk.CTkFrame(self.download_menu_window)
    ...
    def create_tab(self, filename):
        ...
        tree = ttk.Treeview(self.notebook.tab(tab_name), show="tree")
    ...
    def update_tab_title(self, tab_name):
        ...
        try:
            ...
            new_tree = ttk.Treeview(self.notebook.tab(new_tab_name), show="tree")
            new_tree.pack(fill="both", expand=True, padx=10, pady=10)
